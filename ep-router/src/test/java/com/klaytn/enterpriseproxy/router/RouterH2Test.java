...
import com.klaytn.enterpriseproxy.router.config.TestOpH2Config;
...
@Import({TestOpH2Config.class})
public class RouterH2Test {
    private static final Logger logger = LoggerFactory.getLogger(RouterH2Test.class);
    ...
    public void GET_CHAINBASICINFO_TEST() {
        ...
        logger.info("@@@@ CHAIN INFO BASIC BY ID : " + chainInfoBasic + " @@@@");

        List<ChainInfoBasic> chainInfoBasicList = services.getChainInfoBasicByOwner("groundx");
        logger.info("@@@@ CHAIN INFO BASIC BY OWNER : " + chainInfoBasicList + " @@@@");

        List<ChainInfoBasic> chainInfoBasicAllList = services.getChainInfoBasicAll();
        logger.info("@@@@ CHAIN INFO BASIC ALL LIST : " + chainInfoBasicAllList + " @@@@");
    }
